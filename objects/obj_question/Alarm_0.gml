 if(global.resposta_json !=""){
      // Converter o JSON em uma lista de dados
	  show_debug_message(string(global.resposta_json));  // Mostra o valor de resposta_json

     var lista_perguntas = json_parse(global.resposta_json);
